...
class BigNumberVis extends React.PureComponent<BigNumberVisProps, {}> {
  ...
  isPercentagePositive(percentageChange?: string) {
      ...
      return (
        <div
          ...
          style={{
            fontSize,
            height: maxHeight,
            color: this.isPercentagePositive(text)
              ? positiveChangeColor
              : negativeChangeColor,
          }}
        >
  ...
  renderTrendline(maxHeight: number) {
    ...
    const mainColor = this.isPercentagePositive(subheader)
      ? positiveChangeColor
      : negativeChangeColor;
        ...
        >
          <h3
            style={{
              ...
              marginBottom: Math.ceil(
                subheaderFontSize * (1 - PROPORTION.TRENDLINE) * height * 1.3,
              ),
            }}
          >
          ...
          >
            ...
            <div>{this.renderTrendline(chartHeight * 0.75)}</div>
          </div>
