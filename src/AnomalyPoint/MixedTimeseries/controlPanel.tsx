  ...
  controlPanelSections: [
    ...
    // ADDITION
    {
      ...
      controlSetRows: [
        [
          {
            name: 'accept_limitted_cross_filters',
            config: {
              type: 'CheckboxControl',
              description:
                'First column of the first row will be enabled by default for cross filters',
              default: false,
              label: 'Accept Limited Cross Filters',
            },
          },
        ],
        [
          {
            name: 'accept_emit_filters',
            config: {
              type: 'SelectControl',
              label: 'Columns to accept from emit filters',
              description: '',
              multi: true,
              freeForm: false,
              allowAll: true,
